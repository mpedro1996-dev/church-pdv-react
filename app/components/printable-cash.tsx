    ...
    return (
        <div ref={ref} className="w-[48mm] h-[210mm] p-1 flex flex-col">
            ...
            <div className="flex flex-col border-b border-black">
                ...
                <h2 className="text-sm font-bold flex flex-col">Data de abertura:<span className='text-xs'>{cash?.opennedDate ?formatDate(cash?.opennedDate) : "-"}</span></h2>
                ...
                <h2 className="text-sm font-bold flex flex-col">Valor de abertura:<span className='text-xs'><CurrencyFormatter value={cash?.opennedValue ?? 0}/></span></h2>
            ...
            <h2><span className="font-bold">Dinheiro:</span> <CurrencyFormatter value={calculateCash() ?? 0}/></h2>
            <h2><span className="font-bold">Debito:</span> <CurrencyFormatter value={calculateDebit() ?? 0}/></h2>
            <h2><span className="font-bold">Crédito:</span> <CurrencyFormatter value={calculateCredit() ?? 0}/></h2>
            <h2><span className="font-bold">Pix:</span> <CurrencyFormatter value={calculatePix() ?? 0}/></h2>
            <h2><span className="font-bold">Fiado:</span> <CurrencyFormatter value={calculateConsumption() ?? 0}/></h2>
            ...
            <div className="border-b border-black">
                <h2><span className="font-bold">Dinheiro:</span> <CurrencyFormatter value={cash?.cashValue ?? 0}/></h2>
                <h2><span className="font-bold">Debito:</span> <CurrencyFormatter value={cash?.debitValue ?? 0}/></h2>
                <h2><span className="font-bold">Crédito:</span> <CurrencyFormatter value={cash?.creditValue ?? 0}/></h2>
                <h2><span className="font-bold">Pix:</span> <CurrencyFormatter value={cash?.pixValue ?? 0}/></h2>
                <h2><span className="font-bold">Fiado:</span> <CurrencyFormatter value={cash?.consumptionValue ?? 0}/></h2>
            </div>            
